...
<div class="container-fluid py-3 bg-dark text-white shadow">
    <h3 class="text-center m-0">
        <i class="fa fa-tachometer-alt"></i> Admin Dashboard <span class="text-secondary">›</span> Create Category
    </h3>
</div>
        ...
        <div class="col-lg-6">
            <div class="card shadow-lg border-0">
                <div class="card-header bg-primary text-white">
                    <h5 class="m-0"><i class="fa fa-plus-circle"></i> Add New Category</h5>
                </div>
